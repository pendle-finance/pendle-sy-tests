...
import {PendleAaveV3WithRewardsSYUpg} from "pendle-sy/core/StandardizedYield/implementations/AaveV3/PendleAaveV3WithRewardsSYUpg.sol";
    ...
    function deploySY() internal override {
        ...
        sy = IStandardizedYield(
            deployTransparentProxy(
                address(new PendleAaveV3WithRewardsSYUpg(
                ...
                address(1),
                abi.encodeCall(PendleAaveV3WithRewardsSYUpg.initialize, (
                    "SY HyperLend HyperEVM WHYPE",
                    "SY-hHyperEvmWHYPE"
                ))
            )
        );
